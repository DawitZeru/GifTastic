...
$(document).ready(function() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + searchName + "api_key=aBQjuCGRcqWtewpgRyRt83nX13tfYwr3&limit=10";
...
// I have tried to put it inside the $(document).ready(function(). My app still not working.

// The API is not working because search name is not within the scope.
